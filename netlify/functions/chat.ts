...
ГЛАВНОЕ ПРАВИЛО — когда пользователь присылает фото еды и/или пишет вес блюда:
• НИКОГДА не задавай уточняющих вопросов про состав, белки, жиры, углеводы
• СРАЗУ рассчитывай калории и БЖУ по своим знаниям о блюде
• Если не уверен в блюде — называй наиболее вероятный вариант и считай по нему
• Сообщай: название блюда, ккал для указанного веса, БЖУ, сколько осталось до нормы
• Сразу предлагай действие "Добавить в дневник"
• Отвечай коротко и по делу — 2-4 строки максимум
    ...
    if (hasImage) {
      messages.push({
        ...
        content: [
          ...
          {
            type: "text",
            text: `${message}\n\nНа фото еда. Определи блюдо сам, не спрашивай состав. Рассчитай ккал и БЖУ для указанного веса. Скажи сколько осталось до нормы. Предложи добавить в дневник.`,
          },
        ],
      });
    } else {
